...
var Keyboard_1 = require("../Controls/Keyboard");
var Gamepad_1 = require("../Controls/Gamepad");
...
// }
var isLeft = false;
var log_style = { fill: '#000', fontSize: '19px' };
var volLog = 'xv {xvol} : yv {yvol}';
var touchLog = 'touch up [{tup}] : touch down [{tdown}] \ntouch left [{tleft}] : touch right [{tright}]';
var velocityIncline = { 0: 100, 100: 110, 110: 120, 120: 130, 130: 140, 140: 150, 150: 160, 160: 170, 170: 180, 180: 190, 190: 200, 200: 200 };
exports.default = {
    Game: Object,
    Player: Object,
    ...
    init: function (Game, Player) {
        ...
        this.Game.stage.add(this.movement_logs);
        this.Player = Player;
        this.Keyboard = new Keyboard_1.default(this.Game);
        this.Gamepad = new Gamepad_1.default(this.Game);
        this.canJump = false;
        this.onWall = false;
    },
    movement: function () {
    ...
    MoveH: function (ABS) {
        var curVel = this.Player.body.velocity.x;
        var key = curVel < 0 ? curVel * -1 : curVel;
        this.Player.body.velocity.x = velocityIncline[key] * ABS;
        this.Player.body.velocity.x = velocityIncline[key] * ABS;
    },
    colide: function (Player, Wall) {
        // hero on the ground
