var SimpleGame = /** @class */ (function () {
    ...
    SimpleGame.prototype.create = function () {
        ...
        this.truck = this.game.add.sprite(this.game.width / 2 - image.width / 2, this.game.height / 2 - image.height / 2, "truck");
    ...
    SimpleGame.prototype.update = function () {
        ...
        if (this.game.input.activePointer.isDown) {
            ...
            this.truck.position.set(this.game.input.mousePointer.x, this.game.input.mousePointer.y);
